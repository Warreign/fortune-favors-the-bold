...
func load_scene(current_scene: Node, next_scene: String, loading_screen_text: String = "") -> void:
	var loading_screen_instance: Node = initialize_loading_screen(loading_screen_text)
...
func initialize_loading_screen(text: String) -> Node:
	var loading_screen_instance: Node = loading_screen.instantiate()
	loading_screen_instance.set_title_text(text)
